...
class Users{
  ...
  public function userRegistration($data){
    ...
    if ($img_name == "" || $pbno == "" || $name == "" || $mobile == "" || $branch == "" || $email == "" || $password == "" || $username == "") {
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              <strong>Error !</strong> Your password must contain letters & at least 1 number !</div>';
        return $msg;
      ...
      $sql = "INSERT INTO tbl_users(img_name, pbno, name, mobile, branch, email, password, roleid, username) VALUES(:pbno, :name, :mobile, :branch, :email, :password, :roleid, :username)";
      $stmt = $this->db->pdo->prepare($sql);
      $stmt->bindValue(':$img_name', $img_name);
      $stmt->bindValue(':pbno', $pbno);
  ...
  public function addNewUserByAdmin($data){
    ...
    if ($name == "" || $username == "" || $email == "" || $mobile == "" || $password == "") {
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              <strong>Error !</strong> Email already Exist, please try another Email... !</div>';
        return $msg;
    }else{
  ...
  // Select All Download Logs
  public function selectAllDownloadLogs(){
    $sql = "SELECT * FROM hu_download ORDER BY id DESC";
    $stmt = $this->db->pdo->prepare($sql);
    $stmt->execute();
  ...
  public function CheckActiveUser($email){
    ...
    public function userLoginAuthotication($data){
      ...
      if ($email == "" || $password == "" ) {
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Error !</strong> Email or Password must not be Empty !</div>';
          return $msg;
        ...
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Error !</strong> Email Address not found !</div>';
          return $msg;
      }else{
        ...
        if ($chkActive == TRUE) {
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>ACCOUNT PENDING !</strong> Sorry, Your account is currently not active. An administrator needs to activate your account before you can login !</div>';
            return $msg;
        }elseif ($logResult) {
  ...
  //   Get Single User Information By Id Method
    public function updateUserByIdInfo($userid, $data){
      ...
      if ($name == "" || $username == ""|| $email == "" || $mobile == "" || $pbno == "" || $branch == "" ) {
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Error !</strong> Input Fields must not be Empty !</div>';
          return $msg;
